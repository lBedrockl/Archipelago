...
location_tables: Dict[str, List[ERLocationData]] = {
    ...
    "Miquella's Haligtree":[
	    # Haligtree Canopy
	    ERLocationData("HT/HC: Sacramental Bud x3 - to S first side branch", "Sacramental Bud x3"),
	    ERLocationData("HT/HC: Stonesword Key - to S behind waygate arival location", "Stonesword Key"),
	    ERLocationData("HT/HC: Golden Rune [10] 1 - to E after a single drop", "Golden Rune [10]"),
	    ERLocationData("HT/HC: Prattling Pate \"My beloved\" - to E one, then second drop onto large NS Branch, go N then up large branch on left, jump up mushrooms", "Prattling Pate \"My beloved\""),
	    ERLocationData("HT/HC: Fire Grease x3 - to E one drop, second drop onto large NS Branch, go S take small left branch all the way up then go S", "Fire Grease x3"),
    	ERLocationData("HT/HC: Stonesword Key -  to E one drop, second drop onto large NS Branch, go S take small left branch then on a small right branch", "Stonesword Key"),
	    ERLocationData("HT/HC: Aeonian Butterfly x2 - to E one drop, second drop onto large NS Branch, go S take small left branch all the way up, go NW and down a small brach on the left", "Aeoneian Butterfly"),
    	ERLocationData("HT/HC: Golden Rune [10] 2 - to E one drop, second drop onto large NS Branch, go S then left fork", "Golden Ruen [10]"),
	    ERLocationData("HT/HC: Envoy Crown - to E one drop, second drop onto large NS Branch, go S take left fork then S", "Envoy Crown"),
	    ERLocationData("HT/HC: Dappled Cured Meat - to E one drop, second drop onto large NS Branch, go S take right fork", "Dappled Cured Meat"),
	    ERLocationData("HT/HC: Smithing Stone[8] - to E one drop, second drop onto large NS Branch, go S take right fork then SE", "Smithing Stone [8]"),
	    ERLocationData("HT/HC: Preserving Boluses - to E one drop, second drop onto large NS Branch, go S take small left branch all the way up then go NW", "Preserving Boluses"),
	    ERLocationData("HT/HC: Warming Stone x4 - to E one drop, second drop onto large NS Branch, go N", "Warming Stone x4"),
	    ERLocationData("HT/HC: Golden Rune [13] - to E one drop, second drop onto large NS Branch, go N then drop on right and cont N", "Golden Rune [13]"),
	    ERLocationData("HT/HC: Lost Ashes of War - to E one drop, second drop onto large NS Branch, go N then drop on right and cont N, at split go W to small shrine", "Lost Ashes of War"),
	    ERLocationData("HT/HC: Oracle Envoy Ashes - to E one drop, second drop onto large NS Branch, go N then drop on right and cont N, at split go E to top of branch", "Oracle Envoy Ashes"),
	    # Haligtree Town
	    ERLocationData("HT/HC: Flaming Bolt x10 - to E up ladder, S up branch (2/2)", "Flaming Bolt x10"),
    	ERLocationData("HT/HC: Numen's Rune - to E up ladder, S up branch (1/2)", "Numen's Rune"),
    	ERLocationData("HT/HT: Golden Rune [10] - to NW by the first ladder", "Golden Rune [10]"),
    	ERLocationData("HT/HT: Rot Grease x2 - to NW up the first ladder", "Rot Grease x2"),
    	ERLocationData("HT/HT: Pearldrake Talisman +2 - to NW up the first ladder, jump SE over a gap", "Pearldrake Talisman +2"),
    	ERLocationData("HT/HT: Smithing Stone [8] - to NW first building top floor", "Smithing Stone [8]"),
    	ERLocationData("HT/HT: Hefty Beast Bone x6 - to NW first building lower floor", "Hefty Beast Bone x6"),
    	ERLocationData("HT/HT: Golden Rune [13] - to NW first building lower floor rear balcony", "Golden Rune [13]"),
    	ERLocationData("HT/HT: Fire Grease x5 - to NW on small wooden bridge", "Fire Grease x5"),
    	ERLocationData("HT/HT: Ancient Dragon Smithing Stone - to N in the courtyard", "Ancient Dragon Smithing Stone"),
    	# Halingtree Town Plaza
    	#ERLocationData("HT/HT: Somber Smithing Stone [8] - to N on a balcony", "Somber Smithing Stone [8]"),
    	ERLocationData("HT/HP: Golden Rune [12] - beside the grace", "Golden Rune [12]"),
    	ERLocationData("HT/HP: Aeonian Butterfly x4 - to E down on a branch", "Aeonian Butterfly x4"),
    	ERLocationData("HT/HP: Somber Smithing Sone [9] - to S first building top floor", "Somber Smithing Stone [9]"),
    	ERLocationData("HT/HP: Smithing Stone [6] - to S first building top roof", "Smithing Stone [6]"),
    	ERLocationData("HT/HP: Golden Rune [10] - to NE first building lower roof", "Golden Rune [10]"),
    	ERLocationData("HT/HP: Golden Rune [12] - to NE first building lower floor", "Golden Rune [12]"),
    	ERLocationData("HT/HP: Viridian Amber Medallion +2 - to NE first building lower floor in chest", "Veridian Amber Medallion +2"),
    	ERLocationData("HT/HP: Smithing Stone [6] - to NE round building roof", "Smithing Stone [6]"),
    	ERLocationData("HT/HP: Sacramental Bud - to NE round building west wing", "Sacramental Bud"),
    	ERLocationData("HT/HP: Smithing Stone [7] - to NE on a bridge by the elevator", "Smithing Stone [7]"),
    	ERLocationData("HT/HP: Hero's Rune [4] - to NE in the small rotunda by the elevator", "Hero's Rune [4]"),
    	ERLocationData("HT/HP: Smithing Stone [8] - NE in the large rotunda by the elevator", "Smithing Stone [8]"),
    	ERLocationData("HT/HP: Loretta's Mastery - boss of HT", "Loretta's Mastery", boss=True),
    	ERLocationData("HT/HP: Loretta's War Sickle - boss of HT", "Loretta's War Sickle", boss=True),
    ],
    "Elphael, Brace of the Haligtree":[
    	# Prayer Room
    	...
    	ERLocationData("BH/PR: Miquellan Knight's Sword - N down 2 stairs, left door stairs up to balcony, up root to buttress, go E under bell", "Miquellan Knight's Sword"),
    	ERLocationData("BH/PR: Lightning Greatbolt x5 - N down 3 stairs on a railing", "Lightning Greatbolt x5"),
    	ERLocationData("BH/PR: Triple Rings of Light - exit PR then drop to E, imp gate", "Triple Rings of Light"),
    	...
    	ERLocationData("BH/PR: Smithing Stone [7] - N down 3 stairs, S down 2 stairs, N down 2 stairs in room", "Smithing Stone [7]"),
    	ERLocationData("BH/PR: Golden Rune [10] - N down 3 stairs, S down 2 stairs, N down 2 stairs, E balcony in room", "Golden Rune [10]"),
    	ERLocationData("BH/PR: Seedbed Curse - N down 3 stairs, S down 2 stairs, N down 2 stairs, jump down E over railing, E after stairs", "Seedbed Curse"),
    	ERLocationData("BH/PR: Rotten Staff - Miniboss E of PR on outer wall", "Rotten Staff", drop=True),
    	ERLocationData("BH/PR: Numen's Rune - N down 3 stairs, jump down to butress over railing, jump arond piller to S part of outer wall then go S(1/2)", "Numen's Rune"),
    	ERLocationData("BH/PR: Somber Ancient Dragon Smithing Stone - N down 3 stairs, jump down to butress over railing, jump arond piller to S part of outer wall then go S(2/2)", "Somber Ancient Dragon Smithing Stone"),
    	...
    	ERLocationData("BH/PR: Ghost Glovewort [9] 1 - enemy drop(1/5)", "Ghost Glovewort [9]", drop=True),
    	ERLocationData("BH/PR: Ghost Glovewort [9] 2 - enemy drop(2/5)", "Ghost Glovewort [9]", drop=True),
    	ERLocationData("BH/PR: Ghost Glovewort [9] 3 - enemy drop(3/5)", "Ghost Glovewort [9]", drop=True),
    	ERLocationData("BH/PR: Ghost Glovewort [9] 4 - enemy drop(4/5)", "Ghost Glovewort [9]", drop=True),
    	ERLocationData("BH/PR: Ghost Glovewort [9] 5 - enemy drop(5/5)", "Ghost Glovewort [9]", drop=True),
    	ERLocationData("BH/PR: Cleanrot Knight Finlay - N down 3 stairs, jump down to butress over railing, jump to roof, left door in a chest", "Cleanrot Knight Finlay"),
    	ERLocationData("BH/PR: Somber Smithing Stone [9] - N down 3 stairs, jump down to butress over railing, jump arond piller to S part of outer wall then go N", "Somber Smithing Stone [9]"),
    	ERLocationData("BH/PR: Somber Ancient Dragon Smithing Stone - N down 3 stairs, jump down to butress over railing, jump to roof, jump NW to second buttress, go E up buttress, in chest through doorway on E wall", "Somber Ancient Dragon Smithing Stone"),
    	ERLocationData("BH/PR: Seedbed Curse - N down 3 stairs, jump down to butress over railing, jump to roof, jump NW to second buttress, go E up buttress then NW on leadge", "Seedbed Curse"),
    	ERLocationData("BH/PR: Old Fang x5 - N down 3 stairs, S down 2 stairs, N down 2 stairs, after room door on left, take root to leadge", "Old Fang x5"),
    	ERLocationData("BH/PR: Warming Stone x2 - - N down 3 stairs, S down 2 stairs, N down 2 stairs, after room door on left, take root to leadge, take buttress N and to drop balcony, inside room(1/2)", "Warming Stone x2"),
    	ERLocationData("BH/PR: Spiritflame Arrow x15 - N down 3 stairs, S down 2 stairs, N down 2 stairs, after room door on left, take root to leadge, take buttress N and to drop balcony, inside room(2/2)", "Spiritflame Arrow x15"),
    	ERLocationData("BH/PR: Haligtree Soldier Ashes - N down 3 stairs, S down 2 stairs, N down 2 stairs, after room door on left, take root to leadge, take buttress N and jump to roof, drop NW go up stairs infront of large basin", "Haligtree Soldier Ashes"),
    	ERLocationData("BH/PR: Smithing Stone [8] - N down 3 stairs, S down 2 stairs, N down 2 stairs, after room door on left, take root to leadge, take buttress N and jump to roof, drop NW go up stairs, SW by a drop", "Smithing Stone [8]"),
    	# Elphael Inner Wall
    	ERLocationData("BH/IW: Lord's Rune - Miniboss E of IW", "Lord's Rune", drop=True),
    	...
    	ERLocationData("BH/IW: Golden Seed - miniboss in second rot lake", "Golden Seed", drop=True),
    	...
    	ERLocationData("BH/HR: Malenia's Great Rune - BH boss fight", "Malenia's Great Rune", boss=True),
    	ERLocationData("BH/HR: Remembrance of the Rot Goddess - BH boss fight", "Remebrance of the Rot Goddess", boss=True),
