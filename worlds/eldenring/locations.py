...
location_tables: Dict[str, List[ERLocationData]] = {
	...
	ERLocationData("MH/HC: Aeonian Butterfly x2 - from main branch, go S take small left branch all the way up, go NW and down a small brach on the left", "Aeoneian Butterfly"),
    	ERLocationData("MH/HC: Golden Rune [10] - from main branch, go S then left fork", "Golden Ruen [10]"),
