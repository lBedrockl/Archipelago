...
location_tables: Dict[str, List[ERLocationData]] = {
    ...
    "Miquella's Haligtree":[
	    ...
	    ERLocationData("MH/HC: Preserving Boluses - drop to E, drop onto main branch, go S take small left branch all the way up then go NW", "Preserving Boluses"),
	    ERLocationData("MH/HC: Warming Stone x4 - drop to E, drop onto main branch, go N", "Warming Stone x4"),
	    ERLocationData("MH/HC: Golden Rune [13] - drop to E, drop onto main branch, go N then drop on right and cont N", "Golden Rune [13]"),
	    ERLocationData("MH/HC: Lost Ashes of War - drop to E, drop onto main branch, go N then drop on right and cont N, at split go W to small shrine", "Lost Ashes of War"),
	    ERLocationData("MH/HC: Oracle Envoy Ashes - drop to E, drop onto main branch, go N then drop on right and cont N, at split go E to top of branch", "Oracle Envoy Ashes"),
	    # Haligtree Town
    ...
    "Elphael, Brace of the Haligtree":[
    	...
    	ERLocationData("BH/PR: Numen's Rune - N down 3 stairs, jump down to butress over railing, jump arond piller to S part of outer wall then go S, item 1", "Numen's Rune"),
    	ERLocationData("BH/PR: Somber Ancient Dragon Smithing Stone - N down 3 stairs, jump down to butress over railing, jump arond piller to S part of outer wall then go S, item 2", "Somber Ancient Dragon Smithing Stone"),
